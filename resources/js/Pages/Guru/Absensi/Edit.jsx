...
export default function Edit({ absensi, jadwal, siswa }) {
    // Gunakan useForm untuk Edit
    const { data, setData, put, processing, errors } = useForm({
        jadwal_id: absensi.jadwal_id.toString(),
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(route("guru.absensi.update", absensi.id));
    };
