...
function letterToFormValues(letter) {
    const tanggal =
        typeof letter.tanggal_kirim === "string"
            ? letter.tanggal_kirim.slice(0, 10)
            : letter.tanggal_kirim
              ? String(letter.tanggal_kirim).slice(0, 10)
              : "";
...
const FormModalSuratKeluar = (props) => {
    ...
    const onSubmit = (values) => {
        ...
        if (isEdit) {
            ...
            const updateUrl = route("admin.surat-keluar.update", {
        ...
        router.post(route("admin.surat-keluar.store"), values, {
            forceFormData: true,
            preserveScroll: true,
            ...finish,
        });
        ...
        >
            <DialogContent className="max-h-[90vh] max-w-lg overflow-y-auto">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        {isEdit
                            ? "Perbarui informasi surat keluar. Kosongkan unggahan file jika tidak ingin mengganti lampiran."
                            : "Masukkan detail informasi surat keluar baru. Klik simpan ketika selesai."}
                    </DialogDescription>
                </DialogHeader>
...
export default FormModalSuratKeluar;
