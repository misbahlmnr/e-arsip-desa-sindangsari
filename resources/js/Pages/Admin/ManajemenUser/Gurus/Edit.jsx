...
export default function Edit({ guru, mapels }) {
    const { data, setData, put, processing, errors } = useForm({
        name: guru.name || "",
        email: guru.email || "",
        password: "",
        password_confirmation: "",
        mapel_ids: guru.mapels?.map((m) => m.id) || [],
        nip: guru.guru_profile?.nip || "",
        jenis_kelamin: guru.guru_profile?.jenis_kelamin || "",
        tempat_lahir: guru.guru_profile?.tempat_lahir || "",
        tanggal_lahir: guru.guru_profile?.tanggal_lahir || "",
        alamat: guru.guru_profile?.alamat || "",
        no_hp: guru.guru_profile?.no_hp || "",
        status_kepegawaian: guru.guru_profile?.status_kepegawaian || "",
    });

    const submit = (e) => {
        e.preventDefault();
        put(route("admin.manajemen-user.gurus.update", guru.id));
    };
